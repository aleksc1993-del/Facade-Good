...
export interface Order { id: string; clientId: string; number: string; contractNumber?: string; invoiceNumber?: string; status: OrderStatus; createdAt: string; deadline: string; comment: string; items: OrderItem[] }
